//
//  StudentDDetailViewController.m
//  Aquinashs
//
//  Created by Carl Chen on 10/28/13.
//  Copyright (c) 2013 Zhen Chen. All rights reserved.
//

#import "StudentDDetailViewController.h"

@interface StudentDDetailViewController (){
    int classindex;
}

@end

@implementation StudentDDetailViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text=[NSString stringWithFormat:@"Quarter %ld", quarter];
    // Configure the cell...
